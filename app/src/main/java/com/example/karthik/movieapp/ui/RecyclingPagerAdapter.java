...
/**
 * Taken from Jake Wharton's implementation of RecyclingPagerAdapter
 */
...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
     ...
     * converted in {@link #getView}. If the imageAdapter always returns the same
     * type of View for all items, this method should return 1.
     * </p>
     * <p>
     * This method will only be called when when the imageAdapter is set on the
     * the {@link AdapterView}.
     * </p>
     *
     * @return The number of types of Views that will be created by this imageAdapter
     */
     ...
     *
     * @param position The position of the item within the imageAdapter's data set whose view type we
     *        want.
     ...
     *
     * @param position The position of the item within the imageAdapter's data set of the item whose view
     *        we want.
